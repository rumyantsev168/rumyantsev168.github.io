...
// Source: https://rumyantsev168.github.io/static/js/PlayerDisplay.js
...
class PlayerDisplay extends HTMLElement {
    ...
    loadAssets() {
        return new Promise((resolve, reject) => {
            const useLocal = window.PLAYER_DISPLAY_USE_LOCAL_ASSETS;
            const cssHref = useLocal ? "static/css/player-display.css" : "https://rumyantsev168.github.io/static/css/player-display.css";
    ...
    render() {
        ...
        if (!displayName) {
            ...
            playerName.replaceChildren(displayName.replaceColorCodes());
        }
